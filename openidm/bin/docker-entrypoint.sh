...
JAVA_OPTS="${JAVA_OPTS:- -server -XX:MaxRAMPercentage=80 -XX:InitialRAMPercentage=80 -XX:MaxTenuringThreshold=1 -Djava.security.egd=file:/dev/urandom -XshowSettings:vm}"
