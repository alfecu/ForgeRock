        ...
        processDescription: function processDescription(event, Router, Constants, MaintenanceDelegate, SchedulerDelegate, Navigation, AdminRoutesConfig, URIUtils) {
            ...
            MaintenanceDelegate.getStatus().then(function (response) {
                if (response.maintenanceEnabled) {
                    ...
                    MaintenanceDelegate.getUpdateLogs().then(function (updateLogData) {
                        var runningUpdate = _.find(updateLogData.result, function (log) {
                        ...
                        if (_.isUndefined(runningUpdate)) {
                            ...
                            MaintenanceDelegate.disable().then(function () {
