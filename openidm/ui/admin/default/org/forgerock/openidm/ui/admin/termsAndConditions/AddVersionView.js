...
define(["jquery", "lodash", "handlebars", "org/forgerock/openidm/ui/admin/util/AdminAbstractView", "org/forgerock/openidm/ui/common/delegates/ConfigDelegate", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Router", "org/forgerock/commons/ui/common/main/ValidatorsManager", "libs/codemirror/lib/codemirror", "libs/codemirror/mode/xml/xml", "libs/codemirror/addon/display/placeholder"], function ($, _, handlebars, AdminAbstractView, ConfigDelegate, Constants, EventManager, Router, ValidatorsManager, codemirror) {
        ...
        render: function render(args, callback) {
            ...
            ConfigDelegate.readEntityAlways("selfservice.terms").then(function (terms) {
                if (!_.isUndefined(terms)) {
                    ...
                    _this.data.existingVersions = JSON.stringify(_.pick(terms.versions, "version"));
