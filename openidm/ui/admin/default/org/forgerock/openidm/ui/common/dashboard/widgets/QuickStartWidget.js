...
define(["jquery", "handlebars", "underscore", "backbone", "org/forgerock/openidm/ui/common/dashboard/widgets/AbstractWidget", "org/forgerock/commons/ui/common/main/EventManager", "backgrid", "org/forgerock/commons/ui/common/util/BackgridUtils"], function ($, handlebars, _, Backbone, AbstractWidget, eventManager, Backgrid, BackgridUtils) {
    var widgetInstance = {},
        ...
        widgetRender: function widgetRender(args, callback) {
            ...
            _.forEach(this.data.cards, _.bind(function (card) {
        ...
        customSettingsSave: function customSettingsSave(dialogRef, widget) {
            ...
            _.forEach(this.model.QuickObjectCollection.models, function (model) {
                widget.cards.push({
        ...
        customSettingsLoad: function customSettingsLoad(dialogRef) {
            ...
            dialogRef.$modalBody.find("#createQuickLink").bind("click", function () {
                if (!_.isNull(_this.model.editedQuickCard)) {
                    _this.model.editedQuickCard.attributes.name = handlebars.Utils.escapeExpression(dialogRef.$modalBody.find("#quickLinkName").val());
                    _this.model.editedQuickCard.attributes.href = handlebars.Utils.escapeExpression(dialogRef.$modalBody.find("#quickLinkHref").val());
                    _this.model.editedQuickCard.attributes.icon = handlebars.Utils.escapeExpression(dialogRef.$modalBody.find("#quickLinkIcon").val());
                    ...
                    _this.model.QuickObjectCollection.add({
                        "name": handlebars.Utils.escapeExpression(dialogRef.$modalBody.find("#quickLinkName").val()),
                        "href": handlebars.Utils.escapeExpression(dialogRef.$modalBody.find("#quickLinkHref").val()),
                        "icon": handlebars.Utils.escapeExpression(dialogRef.$modalBody.find("#quickLinkIcon").val())
                    });
                }
